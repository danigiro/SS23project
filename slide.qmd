...
- Outlier detection:
  ...
  - damage outlier: 0, 2 or 3 most deadly and the three most damaging instances
  - death oulier: 0, 1 or 2 most deadly and the three most damaging instances
...
## Is this replicability?

Sticking to Machery's definition of replicability, tions should be conceived as involving
the resampling of the experimental components when these are random factors. Each of the experimental components so treated can be the target of
...
stimuli used in experiment A can be replaced with other stimuli in experiment B (see sec. 2.2 for a discussion of whether it makes sense to treat exp
...
<br>
<p class="date" style="text-align: center;">22 Sept 2023, Padova (Italy)</p>
</div>
</div>